...
class line():
    ...
    def mergeLines(self):
        print('Merging Lines...')
        ##keep width of dominant lines proportional to stroke length
...
myDir = r"C:\Users\Sonal.Ganvir\COINS\Data\Input"
#myDir = r"C:\Users\Sonal.Ganvir\COINS\Data\Input\Delhi_final_roads_WGS_indicators"
os.chdir(myDir)
...
if __name__ == '__main__':
    ...
    for file in glob.glob("*.geojson"):
        t1 = time.time()
        if "gt35m" in file:
            filename = file.split(".")[0].split("_gt35m")[0]
        else:
            continue
        ...
        myStreet.exportStrokes(outFile=rf"C:\Users\Sonal.Ganvir\COINS\Data\Output/{filename}_coins.shp")
